        ...
        <div class="bmobbox">
            ...
            <div class="bmobbox-body">
                <div class="bmobboxone">
                    <p class="floatleft bmobboxleft">{{$t('medicalmessage.inspection_date')}}
                    <p>
                        <calendar/>
                ...
                <div class="bmobboxone">
                    <p class="floatleft  bmobboxleft">{{$t('searchtable.report_date')}}
                    <p>
                        <calendar/>
                    <p class="floatleft zhi">{{$t('searchtable.to')}}</p>
                    <calendar/>
                ...
                <div class="bmobboxone">
                    <p class="floatleft  bmobboxleft">{{$t('medicalmessage.sex')}}
                    <p>
                    <form class="floatleft">
                ...
                <div class="bmobboxone">
                    <p class="floatleft  bmobboxleft">{{$t('medicalmessage.Inspection_unit')}}
                    <p>
                ...
                <div class="bmobboxone">
                    <p class="floatleft  bmobboxleft">{{$t('medicalmessage.specimen_type')}}
                    <p>
                        <input type="text" class="bmobboxinputcom  floatleft">
                ...
                <div class="bmobboxone">
                    <p class="floatleft  bmobboxleft">{{$t('searchtable.report_status')}}
                    <p>
                        <input type="text" class="bmobboxinputcom  floatleft">
                ...
                <div class="bmobboxone">
                    <p class="floatleft  bmobboxleft">{{$t('searchtable.attending_doctor')}}
                    <p>
                        <input type="text" class="bmobboxinputcom  floatleft">
                ...
                <div class="bmobboxone">
                    <p class="floatleft  bmobboxleft">{{$t('medicalmessage.clinical_diagnosis')}}
                    <p>
                        <input type="text" class="bmobboxinputlong  floatleft">
                </div>
                <div class="bmobboxone">
                    <p class="floatleft  bmobboxleft">{{$t('searchtable.pathological_diagnosis')}}
                    <p>
                        <input type="text" class="bmobboxinputlong  floatleft">
                </div>
                <div class="bmobboxone">
                    <p class="floatleft  bmobboxleft2">{{$t('searchtable.diagnosis_keywords')}}
                    <p>
